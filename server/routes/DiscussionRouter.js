...
router.get('/deleteFile/:consecutivo/:idpunto/:filename', DiscussionController.deletefile);
...
router.get('/download/:consecutivo/:idpunto/:filename', DiscussionController.getFile);
